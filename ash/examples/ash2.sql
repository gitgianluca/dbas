...
DEF from_time="2023-01-08 00:12:00"
DEF to_time="2023-01-08 18:12:00"

DEF from_time="&1"
DEF to_time="&2"

DEF cols=session_type,IN_CONNECTION_MGMT,top_level_call_name,program,top_level_sql_opcode,top_level_sql_id,sql_opcode,sql_id
...
SELECT * FROM (
  SELECT
    ...
    WHERE
        sample_time BETWEEN TIMESTAMP'&2' AND TIMESTAMP'&3'
